...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        [_currentPositionLabel setFont:[UIFont systemFontOfSize:12]];
        ...
        [_timeLeftLabel setFont:[UIFont systemFontOfSize:12]];
...
- (void)layoutSubviews
{
    ...
    CGSize titleLabelSize = [[_titleLabel text] sizeWithMyFont:_titleLabel.font width:insetBounds.size.width];
    
    if (!_fullscreen) {
        _activityIndicator.activityIndicatorViewStyle = UIActivityIndicatorViewStyleWhite;
        CGSize twoLineSize = [@"M\nM" sizeWithMyFont:_titleLabel.font width:insetBounds.size.width];
...
{
    CGSize titleLabelSize = [@"M\nM" sizeWithMyFont:[_titleLabel font] width:width - _padding - _padding];
