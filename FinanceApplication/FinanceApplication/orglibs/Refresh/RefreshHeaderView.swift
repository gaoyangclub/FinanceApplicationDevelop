...
class RefreshHeaderView: RefreshBaseView {
    ...
    class func header()->RefreshHeaderView{
        var header:RefreshHeaderView  = RefreshHeaderView()
        return header
    }
...
//                println("scrollView交互关闭")
                ...
                UIView.animateWithDuration(RefreshSlowAnimationDuration, animations: {
                    ...
                    top = self.frame.size.height// + self.scrollView.contentInset.top
                    //                    }
                    //                    else{
...
//        self.frame = rect
    ...
    override func adjustStateWithContentOffset()
    {
        ...
        //        }
        var currentOffsetY:CGFloat = self.scrollView.contentOffset.y + self.scrollView.contentInset.top
        var happenOffsetY:CGFloat = 0;//-self.frame.size.height
